...
public class MonticuloArreglo<T extends Comparable<T>>
    ...
    @Override public T elimina() {
        ...
        for(int i = 0; i < arreglo.length; i++) {
            if(minimo == null && arreglo[i] != null) {
                minimo = arreglo[i];
                indice = i;
            } else if(minimo != null && arreglo[i] != null && arreglo[i].compareTo(minimo) < 0) {
                minimo = arreglo[i];
                indice = i;
            }
        }
    ...
    @Override public T get(int i) {
        // Aquí va su código.
        if(i < 0 || i >= elementos)
            throw new NoSuchElementException("El índice esta fuera del rango.");
        return arreglo[i];
    }
